...
import '../../../../colors.dart';
import '../../helper_profile/views/helper_profile_view.dart';
import '../controllers/bricklaying_helper_controller.dart';

class BricklayingHelperView extends GetView<BricklayingHelperController> {
                                    ...
                                    Expanded(
                                      child: SizedBox(height:24,width:110,
                                        child: ElevatedButton(
                                          onPressed: () {controller.  makePhoneCall('1234567890');},
